...
* `dnd-serialize-fn` You can use this attribute to supply your own function serializing the transferred object. By default, objects are serialized with `angular.toJson`.
...
* `dnd-deserialize-fn` You can use this attribute to supply your own function deserializing the transferred object. By default, objects are deserialized with `JSON.parse`.

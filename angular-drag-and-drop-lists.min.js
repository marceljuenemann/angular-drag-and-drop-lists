...
i.dataTransfer.setData("Text",angular.toJson(a.$eval(o.dndDraggable))),i.dataTransfer.effectAllowed=o.dndEffectAllowed||"move",d.addClass("dndDragging"),n(function(){d.addClass("dndDraggingSource")},0),r.dropEffect="none",t.isDragging=!0,t.dragType=o.dndType?a.$eval(o.dndType):void 0
var f=i.target.getBoundingClientRect(),l=i.clientX-f.left,g=i.clientY-f.top
i._dndHandle&&i.dataTransfer.setDragImage&&i.dataTransfer.setDragImage(d[0],l,g),e(o.dndDragstart)(a,{event:i}),i.stopPropagation()}),d.on("dragend",function(i){i=i.originalEvent||i
var f=r.dropEffect
...
return d=r?d:0,t<d+a/2}function f(){var e
...
if(angular.isArray(n)&&n.indexOf(t.dragType)===-1)return!1}return!o.dndDisableIf||!a.$eval(o.dndDisableIf)}function s(){return p.remove(),d.removeClass("dndDragover"),!0}function u(n,r,d,o){return e(n)(a,{event:r,index:d,item:o||void 0,external:!t.isDragging,type:t.isDragging?t.dragType:void 0})}function c(e){if(!e)return!0
...
d.on("dragenter",function(e){return e=e.originalEvent||e,!g(e)||void e.preventDefault()}),d.on("dragover",function(e){if(e=e.originalEvent||e,!g(e))return!0
...
return o.dndDrop&&(n=u(o.dndDrop,e,d,n),!n)?s():(n!==!0&&a.$apply(function(){a.$eval(o.dndList).splice(d,0,n)}),u(o.dndInserted,e,d,n),"none"===e.dataTransfer.dropEffect?"copy"===e.dataTransfer.effectAllowed||"move"===e.dataTransfer.effectAllowed?r.dropEffect=e.dataTransfer.effectAllowed:r.dropEffect=e.ctrlKey?"copy":"move":r.dropEffect=e.dataTransfer.dropEffect,s(),e.stopPropagation(),!1)}),d.on("dragleave",function(e){e=e.originalEvent||e,d.removeClass("dndDragover"),n(function(){d.hasClass("dndDragover")||p.remove()},100)})}}]).directive("dndNodrag",function(){return function(e,n,r){n.attr("draggable","true"),n.on("dragstart",function(e){e=e.originalEvent||e,e._dndHandle||(e.dataTransfer.types&&e.dataTransfer.types.length||e.preventDefault(),e.stopPropagation())}),n.on("dragend",function(e){e=e.originalEvent||e,e._dndHandle||e.stopPropagation()})}}).directive("dndHandle",function(){return function(e,n,r){n.attr("draggable","true"),n.on("dragstart dragend",function(e){e=e.originalEvent||e,e._dndHandle=!0})}}).factory("dndDragTypeWorkaround",function(){return{}}).factory("dndDropEffectWorkaround",function(){return{}})
